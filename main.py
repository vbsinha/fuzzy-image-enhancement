...
from filters import newfilterA, newfilterB, newfilterC, compute_mu_beta_w, TC, filterR1, filterR2, filterR3, filterR3Crisp, filterR4, allfilters
...
parser.add_argument('--method', type=str, choices=['A', 'B', 'C', 'Med', 'R1', 'R2', 'R3', 'R3Crisp', 'R4', 'All'],
